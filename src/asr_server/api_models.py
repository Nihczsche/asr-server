...
from asr_server.text_utils import Transcription, canonicalize_word, segments_to_text
...
class TranscriptionWord(BaseModel):
    ...
    def from_segments(cls, segments: Iterable[TranscriptionSegment]) -> list[TranscriptionWord]:
        ...
        for segment in segments:
            # NOTE: a temporary "fix" for https://github.com/fedirz/asr-server/issues/58.
